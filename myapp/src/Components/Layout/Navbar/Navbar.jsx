        ...
        <div className="container-lg container-fluid pt-4 pb-3">
          <div className="row align-items-center">
            <div className="col-3">
              <div className="logo">
                <img
                  src="https://ui.highspeedtraining.co.uk/components/2022.11.30.338/images/svg/logo-blue.svg"
                  alt=""
                />
              </div>
            </div>
            <div className="col-9">
              ...
              <div className="col-12">
                <div className="mobil_navbar">
                  <AiOutlineSearch />
                  <BsList onClick={() => setEnableMenu(!enableMobileMenu)} />
